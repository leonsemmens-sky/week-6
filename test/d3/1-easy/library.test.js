const app = require("../../../d3/1-easy/library");
const { Book } = require("../../../d3/1-easy/models/book");
...
describe("app", () => {
  ...
  describe("GET /books", () => {
    ...
    test("response body contains a list of books", async () => {
      ...
      expect(
        body.every(({ isbn, author, title }) => isbn && author && title)
      ).toBe(true);
    });
  });
